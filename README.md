...
[繁體中文](README.zh-TW.md) · [Open Gemini Notebook](https://notebook.google.com/) · [Contributing](CONTRIBUTING.md)

## 🚀 [Open Live Website](https://dennis23100.github.io/gemini-notebook-prompt-lab/)

**Try the app instantly in your browser — no install, account, API key, or backend required.**

...
網站提示詞庫目前會顯示 31 張、涵蓋 11 個主題的 Gemini Notebook 實際輸出範例。其中 8 個主題具有兒童／青年／成熟讀者三種版本；大自然與海洋補齊青年／成熟讀者，叢林則已具有三種年齡層。Repository README 維持文字導覽；請直接開啟網站，以卡片尺寸瀏覽真實預覽。
...
網站提示詞庫目前有 31 張逐張驗證過的原始 PNG 範例。只有經驗證的實際生成結果會顯示成卡片圖片；其餘卡片維持純文字，避免把風格示意誤認成 Gemini Notebook 的實際輸出。
